...
import org.netbeans.modules.java.duplicates.indexing.DuplicatesCustomIndexerImpl;
import org.netbeans.modules.java.duplicates.indexing.DuplicatesIndex;
...
public class ComputeDuplicates {
    ...
    public Iterator<? extends DuplicateDescription> computeDuplicatesForAllOpenedProjects(ProgressHandle progress, AtomicBoolean cancel) throws IOException {
        Set<URL> urls = getAllSourceRoots();
    ...
    public static Set<URL> getAllSourceRoots() {
    ...
    public Iterator<? extends DuplicateDescription> computeDuplicates(Set<URL> forURLs, ProgressHandle progress, AtomicBoolean cancel) throws IOException {
        ...
        Map<IndexReader, FileObject> readers2Roots = openReaders(forURLs, true, cancel);
...
//        dd = dd.subList(0, dd.size() / 10 + 1);
    ...
    private static Map<IndexReader, FileObject> openReaders(Set<URL> forURLs, boolean updateIndices, AtomicBoolean cancel) {
        //TODO: closing the readers?
        Map<IndexReader, FileObject> readers2Roots = new LinkedHashMap<>();
        ...
        return readers2Roots;
    }

    public static Iterator<? extends DuplicateDescription> duplicatesOf(Set<URL> forURLs, Collection<String> hashes, AtomicBoolean cancel) {
        Map<IndexReader, FileObject> readers2Roots = openReaders(forURLs, true, cancel);
