...
//        System.err.println("resolveCompletionItem=" + ci.getData());
        JsonObject rawData = (JsonObject) ci.getData();
        if (rawData == null) {
            return CompletableFuture.completedFuture(ci);
        }
//        System.err.println(new Gson().toJson(rawData));
        CompletionData data = new Gson().fromJson(rawData, CompletionData.class);
//        System.err.println("data=" + data.toString());
//        if (true) {
//            throw new IllegalStateException(new Gson().toJson(rawData) + "/" + String.valueOf(data));
//        }
        try {
