 ...
 * under the License.
 */
package org.netbeans.modules.java.generic.project.ui.customizer;
...
public class CustomizerProviderImpl implements CustomizerProvider2 {
    ...
    public CustomizerProviderImpl(GenericJavaProject project) {
        this.project = project;
    }

    @Override
    public void showCustomizer(String preselectedCategory, String preselectedSubCategory) {
        ProjectCustomizer.createCustomizerDialog("Projects/" + GenericJavaProject.PROJECT_KEY + "/Customizer",
                                                 project.getLookup(),
                                                 preselectedCategory,
                                                 evt -> {},
