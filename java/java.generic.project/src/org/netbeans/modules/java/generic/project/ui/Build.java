 ...
 * under the License.
 */
package org.netbeans.modules.java.generic.project.ui;
...
public class Build extends javax.swing.JPanel {
    ...
    @CompositeCategoryProvider.Registration(projectType=GenericJavaProject.PROJECT_KEY, position=200)
    public static CompositeCategoryProvider createCategoryProvider() {
        return new CompositeCategoryProvider() {
            ...
            public JComponent createComponent(Category category, Lookup context) {
                GenericJavaProject prj = context.lookup(GenericJavaProject.class);
                ...
                category.setStoreListener(evt -> prj.getActiveBuildConfiguration().save(GenericJavaProject.getBuildPreferences(prj.getProjectDirectory())));
                return panel;
            }
        };
    }
