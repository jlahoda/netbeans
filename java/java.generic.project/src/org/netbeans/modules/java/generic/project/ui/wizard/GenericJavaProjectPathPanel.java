...
import org.netbeans.modules.java.generic.project.ui.wizard.GenericJavaProjectWizardIterator.GenericJavaProjectSettings;
 ...
 * @author lahvac
 */
public class GenericJavaProjectPathPanel extends javax.swing.JPanel {
     ...
     */
    public GenericJavaProjectPathPanel() {
        initComponents();
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(GenericJavaProjectPathPanel.class, "GenericJavaProjectPathPanel.jLabel1.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(fileChooser, org.openide.util.NbBundle.getMessage(GenericJavaProjectPathPanel.class, "GenericJavaProjectPathPanel.fileChooser.text")); // NOI18N
        ...
        path.setText(org.openide.util.NbBundle.getMessage(GenericJavaProjectPathPanel.class, "GenericJavaProjectPathPanel.path.text")); // NOI18N
    ...
    public static class PanelImpl implements WizardDescriptor.FinishablePanel<WizardDescriptor> {
        ...
        private GenericJavaProjectPathPanel panel;

        @Override
        public GenericJavaProjectPathPanel getComponent() {
            if (panel == null) {
                panel = new GenericJavaProjectPathPanel();
            }
            return panel;
        }
        ...
        public void storeSettings(WizardDescriptor wizard) {
            GenericJavaProjectSettings.get(wizard).setProjectPath(getComponent().path.getText());
        }
