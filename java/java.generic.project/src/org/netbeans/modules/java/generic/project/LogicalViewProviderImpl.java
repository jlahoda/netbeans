...
public class LogicalViewProviderImpl implements LogicalViewProvider  {
    ...
    private static final class RootNode extends AbstractNode {
        ...
        public RootNode(Project p) {
            ...
            this.project = p;
            setDisplayName();
            setIconBaseWithExtension("org/netbeans/modules/java/generic/project/resources/project.png");
        }
        ...
        public Action[] getActions(boolean context) {
            return CommonProjectActions.forType(GenericJavaProject.PROJECT_KEY);
        }
