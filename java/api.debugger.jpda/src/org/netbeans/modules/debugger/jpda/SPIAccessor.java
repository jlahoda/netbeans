...
public abstract class SPIAccessor {
    ...
    public abstract Context newContext(FileObject baseDir, String actionName, ClassPath jdkSourcePath, ClassPath sourcePath, String transport);
}
