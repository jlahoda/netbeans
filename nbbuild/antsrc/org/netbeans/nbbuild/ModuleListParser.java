...
final class ModuleListParser {
    ...
    private static Map<String,Entry> scanNetBeansOrgSources(File root, Map<String,Object> properties, Project project) throws IOException {
        ...
        if (entries == null) {
            ...
            try (InputStream packagesIn = new FileInputStream(new File(root, "platform/o.n.bootstrap/src/org/netbeans/jdk/jdk8-modules-packages"));
                 InputStream jarsIn = new FileInputStream(new File(root, "platform/o.n.bootstrap/src/org/netbeans/jdk/jdk8-modules-files"))) {
            ...
            for (String key : modules2Packages.stringPropertyNames()) {
                ...
                entries.put(key, new Entry(key, jars.get(0), jars.subList(1, jars.size()).toArray(new File[0]), null, null, null, new String[0], null, new String[0], Collections.<String, String[]>emptyMap(), null, attr));
            }
            Attributes attr = new Attributes();
    ...
    public static final class Entry implements Serializable {
        ...
        Entry(String cnb, File jar, File[] classPathExtensions, File sourceLocation, String netbeansOrgPath, String netbeansOrgId,
            ...
            this(cnb, jar, classPathExtensions, sourceLocation, netbeansOrgPath, netbeansOrgId, buildPrerequisites, clusterName, runtimeDependencies, testDependencies, moduleAutoDeps, null);
        }
