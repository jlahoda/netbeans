...
public class TestUtils {
    ...
    public static LineBreakpoint createLineBreakpoint(Line line) {
        ...
        LineBreakpoint b = new LineBreakpoint(LineBreakpoint.TOPLEVEL);

        b.setFileAndLine(filePath, lineNumber);
