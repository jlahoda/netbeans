...
public class JavaCompletionTask111FeaturesTest extends CompletionTestBase {
    ...
    public void testEmptyFileAfterTypingLambdaParam() throws Exception {
        performTest("SimpleLambdaExpression2Start", 1086, "t.test((s ", "empty.pass", "1.11");
    }

    public void testEmptyFileAfterTypingTypeOfLambdaParam() throws Exception {
        performTest("SimpleLambdaExpression2Start", 1086, "t.test((String ", "stringVarName.pass", "1.11");
    }

    public void testFirstLambdaParam() throws Exception {
        performTest("SimpleLambdaExpression2Start", 1086, "t.test((", "lambdaParameterTypesIncludingVar.pass", "1.11");
    }
    ...
    public void testSecondLambdaParam2() throws Exception {
        performTest("SimpleLambdaExpression2Start", 1086, "t.test((String s,", "lambdaParameterTypesExcludingVar.pass", "1.11");
    }

    public void testSecondLambdaParam3() throws Exception {
        performTest("SimpleLambdaExpression2Start", 1086, "t.test((var s,", "var.pass", "1.11");
    }

    public void testSecondLambdaParam4() throws Exception {
        performTest("SimpleLambdaExpression2Start", 1086, "t.test2( \"hello\",2,( var s,", "var.pass", "1.11");
    }

    public void testSecondLambdaParam5() throws Exception {
        performTest("SimpleLambdaExpression2Start", 1086, "t.test2( \"hello\",2,( String s,", "lambdaParameterTypesExcludingVar.pass", "1.11");
    }
